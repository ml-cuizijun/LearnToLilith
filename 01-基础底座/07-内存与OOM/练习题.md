...
先对照 [知识点](知识点.md)：**先 [一、一张图：一页内存的一生](知识点.md) 总图，再 [三、入账：账本、RSS 与 available 🎯⭐🔧](知识点.md)，再 [五、击杀：OOM Killer 与两条杀法 🎯🔥](知识点.md) 两条杀法**。能讲清账本再谈 137。每题标了覆盖范围：
...
- [ ] 默画账本（见 [一张账本：物理内存怎么切 ⭐](知识点.md)）：物理页怎么切？决策看哪一列？
