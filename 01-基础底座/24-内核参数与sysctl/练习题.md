...
**★★★★★｜什么时候调 somaxconn，什么时候调 rmem/wmem？和 12/13 怎么分工？**
...
**一句话**：LISTEN 顶满调队列（somaxconn/listen）；ESTAB 缓冲/窗口问题先按 12/13 定责，再谈 rmem/wmem；18 只管落盘边界。
...
**一句话**：count/max >80% 告警；表满间歇丢新连接；调 max 买时间，治本少短连接或切 IPVS（含义见 17）。
