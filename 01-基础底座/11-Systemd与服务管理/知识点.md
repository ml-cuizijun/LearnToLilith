...
| 章 | 负责 |
|----|------|
| **02** | 信号、优雅退出、僵尸——进程自己怎么死 |
| **13（本章）** | PID 1、unit、Type、Restart、journal、依赖、开机自启 |
| **18 / 22 / 19** | sysctl fd、journal 盘满、时间/时区 |
...
| 盘被打满 | `--disk-usage` / vacuum | 深策略见 22 |
