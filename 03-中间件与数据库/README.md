...
> 可观测性（Prometheus/告警/SLO/日志采集）在 [04-Kubernetes](../04-Kubernetes/) 的 18、19 章，这里不重复。
...
Nginx 配置细节以 [02-23 Nginx](../02-基础底座/23-Nginx/) 为准；本章网关只抓超时链、动态配置、和 APISIX 的差别。  
etcd 运维以 [04-02 etcd](../04-Kubernetes/02-etcd/) 为准。
