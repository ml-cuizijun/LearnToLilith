...
- [3. 原理](#3-原理)
  ...
  - [3.3 EXPLAIN](#33-explain-只看这几列)
  - [3.4 MVCC](#34-mvcc快照读当前读)
  - [3.5 redo / binlog](#35-一次-commitredo-binlog-两阶段)
  - [3.6 锁](#36-锁和死锁)
  - [3.7 复制](#37-主从-gtid-半同步)
- [4. 安装部署](#4-安装部署)
- [5. 核心配置](#5-核心配置)
- [6. 常用命令](#6-常用命令)
- [7. 常用操作](#7-常用操作)
  ...
  - [7.3 故障切换](#73-故障切主)
  - [7.4 PITR](#74-误删-pitr)
  - [7.5 大表 DDL](#75-大表-ddlinstant--inplace--gh-ost)
  - [7.6 升级](#76-升级)
  - [7.7 回滚](#77-回滚)
  - [7.8 扩容](#78-扩容与容量)
- [8. 生产排障](#8-生产排障)
...
### 7.5 大表 DDL：INSTANT / INPLACE / gh-ost
