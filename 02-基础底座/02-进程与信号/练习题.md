...
- [ ] 能说出 R/S/D/Z/T，以及 Load = R+D、S 不计入
- [ ] 能解释 D 为什么杀不掉，并能按 wchan 走到 NFS / 盘 / 脏页
- [ ] 能处理僵尸：查 ppid、修 wait；知道危险是 pid_max 不是 RSS
- [ ] 能把游戏服停服讲到 TERM → 刷盘 → exit 0，并说明 OOM 没有优雅退出
- [ ] 能说出容器 PID 1 两层原因和 tini / exec 形式
- [ ] 能用短窗口 strace -c，能查 fd 泄漏，能让 139 的 core 落盘
- [ ] 能读 137 / 139 / 143，并区分 fork ENOMEM 和宿主机还有内存
