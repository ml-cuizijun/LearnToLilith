...
先对照 [知识点](知识点.md) **本章主线** 自己口述，再对答案。关键字（502/504/499、curl -w 五段、证书链、Keep-Alive）要能分码。每题标了覆盖范围：
...
- [ ] 502 / 504 / 499 各是谁先放手？error.log 关键字是什么？
- [ ] 超时为什么必须从外到内递减？timeout=300s 为什么不是修复？
- [ ] HTTP/1.1 和 HTTP/2 对队头阻塞差在哪？战斗长连接能用 Keep-Alive 回答吗？
- [ ] 证书链三截是什么？过期、缺中间证、SNI 错各什么表现？
- [ ] 支付为什么禁止 0-RTT？RSA 高峰怎么治？
- [ ] CDN 502、源站 localhost 正常、边缘绿锁，先查哪一跳？
