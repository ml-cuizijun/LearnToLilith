...
先对照 [知识点](知识点.md) **本章主线** 自己口述，再对答案。关键字（MemAvailable、137、working_set、oom_score_adj、Xmx）要能结案。每题标了覆盖范围：
...
- [ ] 判断内存够不够看哪一列？used 高为什么经常不是故障？
- [ ] 137 怎么分整机 OOM、cgroup OOM、人手 -9？score 怎么用？
- [ ] 容器 OOM 为什么跟宿主机剩余无关？Xmx 怎么定？
- [ ] 泄漏和打满怎么分？dump 什么时候才定泄漏？热更打满先做什么？
- [ ] 为什么不要给业务 -1000？request=limit 还会被杀吗？
- [ ] Swap 用了还能撑吗？THP 和 drop_caches 生产怎么处理？
