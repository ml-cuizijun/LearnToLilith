...
**ndots:5 让外网短名先白查三遍集群域，一次查询放大成四次。**
...
**DNS 打满要先分垃圾查询、有效 QPS、conntrack、Endpoints 被摘空。**
...
**HostNetwork 默认继承节点 DNS，要 ClusterFirstWithHostNet 才能用集群 DNS。**
