...
**restartPolicy 决定容器退出后 kubelet 要不要再来拉。**
...
**调度看 request；容器 OOM 看 limit；节点压力赶人叫 Evicted。**
