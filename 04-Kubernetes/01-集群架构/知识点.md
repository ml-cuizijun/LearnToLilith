...
**每个控制器都在 Observe → Diff → Act 同一圈上转。**
...
**所有组件只 Watch 和改 API，Scheduler 不会给 kubelet 打电话。**
...
**kubeadm 刚装完只有本机容器，跨节点和 DNS 要靠插件。**
