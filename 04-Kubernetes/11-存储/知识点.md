...
**WFFC 等 Pod 落点再在该 AZ 建盘；waiting for first consumer 不是故障。**
...
**云盘 RWO 只能单节点挂；Deployment 多副本抢一块只会有一个 Running。**
...
**Terminating 是 finalizer 没摘完；PVC/PV 等 CSI 卸卷。**
