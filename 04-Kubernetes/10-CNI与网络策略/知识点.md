...
**Pod IP 是 kubelet 调 CNI IPAM 分的，不是 kube-proxy 也不是 Scheduler。**
...
**生产要选带 NetworkPolicy 的 CNI；裸 Flannel 上 NP 是死数据。**
...
**无 NP 时东西向全通；Pod 被 NP 选中后该方向默认拒。**
