...
先别动手。这一章后半全是你会动手的：**本 AZ NAT、VPC Endpoint、NLB 两套 SG、IRSA Trust、Spot 两分钟怎么收尸。** 前面的概念和原理，是为了让你动手时不把中国区经验套到 Global。
...
- [6. 常用命令](#6-常用命令)
- [7. 常用操作](#7-常用操作)
  - [7.1 S3 生命周期](#71-s3-生命周期按前缀)
  - [7.2 CloudWatch vs Prometheus](#72-cloudwatch-vs-prometheus)
  - [7.3 出海检查清单](#73-出海检查清单)
- [8. 生产排障](#8-生产排障)
- [9. 必会 · 常考](#9-必会--常考)
- [合上书](#合上书问自己)
...
先把整张图钉住。后面 Endpoint、NLB、IRSA 都对着这张图说话。
