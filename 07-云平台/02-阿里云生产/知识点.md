...
先别动手。这一章后半全是你会动手的：**规格怎么禁 t、探测怎么放 100.64、Terway IP 不够怎么加网段、RAM 角色怎么绑。** 前面的概念和原理，是为了让你动手时不选错产品层。
...
- [6. 常用命令](#6-常用命令)
- [7. 常用操作](#7-常用操作)
  - [7.1 OSS + CDN 热更](#71-oss--cdn-热更)
  - [7.2 SLS 与云监控](#72-sls-与云监控)
  - [7.3 RDS / Redis 开服夜](#73-rds--redis-开服夜)
  - [7.4 开服当天组合检查](#74-开服当天组合检查)
- [8. 生产排障](#8-生产排障)
- [9. 必会 · 常考](#9-必会--常考)
- [合上书](#合上书问自己)
...
先把整张图钉住。后面规格、LB、ACK、RAM 都对着这张图说话。
