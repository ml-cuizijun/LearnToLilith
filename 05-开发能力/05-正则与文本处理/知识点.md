...
**本章不讲：** 值班 one-liner / 日志现场刀法 → [01-03 文本三剑客](../../01-基础底座/03-文本三剑客/)；生产脚本三开关 → [01 Shell](../01-Shell/)；时间窗 + API 编排 → [02 Python](../02-Python运维/)、[04 实战](../04-运维开发实战题/)；日志平台架构 → [03-K8s 19](../../03-Kubernetes/19-日志管理/)、[01-23 日志](../../01-基础底座/23-日志运维/)。
