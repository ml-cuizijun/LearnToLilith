...
**本章不讲：** 复杂 JSON / HTTP → [02 Python](../02-Python运维/)；正则抠字段 → [05](../05-正则与文本处理/)；批量部署整题 → [04](../04-运维开发实战题/)；Ansible → [05-工程化 04-Ansible](../../04-工程化与自动化/04-Ansible/)。
...
**易错**：探活过了 ≠ 对玩家开放；登录冒烟见 [08-游戏 02](../../07-游戏运维专题/02-开服合服/)。
