...
开始做题前，先给大家一个小建议：合上 [知识点](知识点.md)，对着 **主图「一条远程命令的一生」** 口述一遍。能顺下来，下面这些题你会发现大半都会了；卡壳的地方，就是你该回去重读的那一节。
...
题目的顺序也是有意排的：Q1、Q2 先把引号与 BatchMode 钉死；中间顺着超时 / 并发 / 失败列表展开；末尾作战与综合。
