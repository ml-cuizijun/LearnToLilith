...
- [ ] kubelet → CRI → containerd → runc 谁起 pause？排障为什么用 crictl？
- [ ] cordon 和 drain 差在哪？卡住四件事是什么？
- [ ] NotReady 时间线？kubelet 挂了先救谁？
- [ ] Allocatable 怎么算？不预留会怎样？
- [ ] kubeadm 升级顺序？kubelet 能不能比 API 新？
- [ ] 战斗服节点怎么升？和发版窗口为什么要错开？
