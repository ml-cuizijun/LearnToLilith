...
开始做题前：合上知识点，对着**第一节的主图**，把「一个 Pod 的一生」口述一遍——出生三道关 → 三探针值守 → 生病退避 → 死亡五步 → QoS 驱逐顺序。讲得出来再做题。
...
题目顺序：Q1～Q2 出生与状态；Q3～Q6 三探针与错配；Q7～Q9 崩溃、优雅退出、QoS；Q10～Q14 游戏有状态与综合定责。
...
能拦住「拉 delay / 共用 health / 先 force」三类误操作，这章过关。
