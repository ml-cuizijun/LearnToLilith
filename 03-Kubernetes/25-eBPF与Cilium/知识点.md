...
- [ ] eBPF 为什么比乱加载 ko 安全？转发经不经 agent？
- [ ] iptables / IPVS / Cilium 各解决哪一段？小集群要不要换？
- [ ] agent 挂了三句影响面？为什么不能先重启战斗服？
- [ ] Hubble 能看到什么？drop 和 forwarded 分别下一步？
- [ ] 可观测和安全差在哪？L7 开在支付还是心跳？
- [ ] 关 kube-proxy 前确认什么？游戏池分批怎么走？
