...
**本章不讲：** 本机 journald / rsyslog / **logrotate** → [01-23 日志运维](../../01-基础底座/23-日志运维/)；Prometheus、SLO、exemplar → [18 监控](../18-监控与可观测性/)；Events 排障、先落盘 → [17](../17-排障实战/)；API 审计策略字段 → [03](../03-API-Server/)；节点 DiskPressure 驱逐机制 → [16](../16-节点运行时与升级/)。
