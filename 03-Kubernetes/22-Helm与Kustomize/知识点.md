...
- [ ] Helm / Kustomize 最终落地的是什么？Release 历史在哪？
- [ ] 两个版本号差在哪？CI 为什么必须先 template？
- [ ] `--atomic` 和手动 rollback 谁在什么时候用？Argo 管了还能 helm rollback 吗？
- [ ] 四种 Kustomize patch 各干什么？generator 为什么会滚动？
- [ ] 社区组件和自有网关怎么分工？混用时所有权怎么定？
- [ ] Secret 为什么不进 values？uninstall 怎样才不会把盘带走？
