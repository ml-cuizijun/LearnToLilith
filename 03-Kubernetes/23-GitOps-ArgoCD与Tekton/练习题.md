...
开始做题前：合上知识点，对着**本章主线**口述一遍——Pull 对齐 → 所有权唯一 → hook/prune。讲得出来再做题。

每道题先看场景自己答，再对完整解答。

题目顺序：Q1～Q3 钉 GitOps 定义与回滚；Q4～Q9 发布链与踩坑；Q10～Q14 组件与定责。
...
- [ ] GitOps 和传统 CI/CD 差在哪？YAML 在 Git 算不算？（知识点 §1 / Q1）
- [ ] OutOfSync 怎么发现？生产能开 auto-sync + self-heal 吗？（知识点 §3.1 / Q2、Q7、Q11）
- [ ] self-heal 下怎么回滚才有效？（知识点 §3.3 / Q3）
- [ ] 完整发布链 CI/CD 边界？Tekton 最后一步做什么？（知识点 §3.4 / Q4、Q6、Q9）
- [ ] Sync Hook / wave？合服能当 PreSync 吗？（知识点 §3.2 / Q5）
- [ ] HPA 扩完被 Argo 打回？误 prune 第一刀？（Q8、Q12、Q13、Q14）
- [ ] 三组件职责、60 秒定责（Q10、Q14）
