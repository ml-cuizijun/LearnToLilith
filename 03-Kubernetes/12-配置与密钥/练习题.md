...
开始做题前：合上知识点，对着**第一节的主图**，把「一份配置的一生」口述一遍——来源 → 户口 → 注入 → 生效 → 变更轮转。讲得出来再做题。

每道题先看场景自己答，再对完整解答。

题目顺序：Q1～Q3 真相与注入；Q4～Q8 轮转与细节；Q9～Q13 变更与下发；Q14 定责剧本。
...
十条都能不看稿讲下来，这一章就过了。终极测试：拦住开篇那两个误操作。
