...
- [ ] CRD 和 Operator 谁登记类型、谁执行？只有 CRD 你会看到什么？
- [ ] 一次 apply 到 Ready 五步卡在哪？手改 STS 为什么会被改回去？
- [ ] 和解循环为什么必须幂等？多副本为什么必须选主？
- [ ] served / storage / conversion 各管什么？升 CRD 删字段会怎样？
- [ ] Terminating 第一刀？finalizer 和 owner 差在哪？RBAC 为什么禁止 `*`？
- [ ] 何时不该写 Operator？挂了该不该重启逻辑服？
