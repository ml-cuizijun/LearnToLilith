...
开始做题前：合上知识点，对着**本章主线**口述一遍——两件套 → 和解循环 → 卡死怎么查。讲得出来再做题。

每道题先看场景自己答，再对完整解答。

题目顺序：Q1～Q3 钉两件套与循环；Q4～Q6 升 CRD / Terminating / 没反应；Q8～Q14 选型与定责。
...
- [ ] CRD 和 Operator 是什么关系？只有 CRD 会怎样？（知识点 §1 / Q1）
- [ ] 什么场景该写 Operator？为什么不是银弹？（知识点 §5–6 / Q2、Q8）
- [ ] 和解循环怎么转？手改 STS 为什么会被改回去？（知识点 §3.1 / Q3）
- [ ] 升 CRD 删字段为什么危险？conversion 什么时候必须有？（知识点 §3.3 / Q4、Q12）
- [ ] CR 一直 Terminating，能不能手抠 finalizer？（知识点 §3.4 / Q5）
- [ ] Operator 挂了游戏服还在吗？spec 没反应按什么顺序查？（Q6、Q9、Q14）
- [ ] ownerReferences、PDB、双 Operator 抢管（Q10、Q11、Q13）
