...
**本章不讲：** 探针、preStop、grace → [04](../04-Pod生命周期/)；Deployment 滚动字段、PDB → [05](../05-工作负载控制器/)；HPA 和 replicas → [07](../07-弹性伸缩/)；Ingress / Gateway weight 实现 → [14](../14-Ingress与流量管理/)；CM env 不热更 → [12](../12-配置与密钥/)；热更 / 开合服运营 → [07-02](../../07-游戏运维专题/02-开服合服/)、[07-03](../../07-游戏运维专题/03-热更新与版本发布/)；ArgoCD / Rollouts / Tekton → [22](../22-GitOps-ArgoCD与Tekton/)、[05](../../04-工程化与自动化/)。Helm CR 和流水线在 21、22。
