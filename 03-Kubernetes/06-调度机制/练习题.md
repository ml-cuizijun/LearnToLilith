...
开始做题前：合上知识点，对着**第一节的主图**，把「一个 Pod 的调度之旅」口述一遍——入队 → 过滤 → 打分 → 绑定，Pending 卡在哪一步、过滤失败还有什么分支。讲得出来再做题。
...
题目顺序：Q1～Q2 主线与定责；Q3～Q6 五道门；Q7～Q10 抢占与绑定；Q11～Q14 综合与剧本。
...
能拦住「调 Score 权重 / 重启调度器 / 战斗服低优先级」三类误操作，这章过关。
