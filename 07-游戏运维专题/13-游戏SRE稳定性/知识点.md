...
> 这一章讲完，你会知道当时「网关 99.9% 没破 SLO」和「三个人同时切主」各自错在哪，以及错误预算与唯一指挥官怎么用。
> **本章回答的问题**：一次故障从 SLO 定标到复盘回灌，每一步会坏什么、值班第一刀是什么。
> **本章不讲**：主机 HA 理论 → [01-33](../../01-基础底座/33-高可用与容灾/)；监控底座 → [01-22](../../01-基础底座/22-监控与告警/)；摘流发布 → [01](../01-游戏服务器架构/)、[05](../05-热更新与版本发布/)；回档 → [09](../09-玩家数据备份与回档/)。

**标记**：🎯重点 · 🔥难点 · ⭐常考 · 🔧实操

**怎么听这场分享**：先把第一节「一次故障的一生」看熟——定标→告警→定位→止血→复盘回灌；第二到第六节顺着这条线走，第七节专门讲开头那个 CCU 腰斩现场怎么定责。每一节讲完会提示对应练习题，趁热打铁。
...
好，主图装进脑子了。接下来从「定标」开始——玩家废了什么才叫破线。
...
🔥 大白话：**SLO 看玩家废了什么**（登录/进战斗/支付），不是看网关 200 率。登录绿、战斗破 → 查 battle SLI，别拿网关 99.9% 挡枪。
...
定标讲完。大家想想：登录 90%、网关 99.9%，算不算破 SLO？很多人只看网关——⭐ 这是高频错答。
...
大家想想：CPU 全绿、CCU 腰斩，是不是机器没问题？很多人会答「那就不是我们的事」——错了。先查变更与分服/分玩法，别被 CPU 绿骗了。
...
⭐ 这是值班铁律。CCU 腰斩时三个人同时切主、回指针、重启——错了。🔥 **一件事、一个指挥官、只做演练过的预案**。
