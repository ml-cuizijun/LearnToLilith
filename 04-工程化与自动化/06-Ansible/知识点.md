...
- [ ] 四个对象各干什么？第二次 changed≠0 查哪三因？
- [ ] Handler 和普通 task 差在哪？逻辑服能不能 `restarted`？
- [ ] 批量变更顺序？`--limit` 写空会怎样？serial 10% 仍全挂说明什么？
- [ ] pipelining / forks / facts 怎么排？高峰能不能加 forks？
- [ ] 回滚怎么和发布对称？动态 inventory 挂了呢？Vault / AWX 解决什么？
- [ ] 和 Terraform / GitOps 怎么分工？改超时、出镜像、热更包各走谁？
