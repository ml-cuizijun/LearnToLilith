...
**本章不讲：** digest 晋升、Harbor、禁 latest、扫描门禁细节 → [03](../03-制品与镜像/)；流水线何时 build → [02](../02-CI-CD/)；containerd / CRI / pause / 节点升级 → [03-16](../../03-Kubernetes/16-节点运行时与升级/)；cgroup 明细、逃逸链 → [01-10](../../01-基础底座/10-cgroup与容器/)；K8s 探针、preStop、terminationGracePeriod → [03-04](../../03-Kubernetes/04-Pod生命周期/)。
