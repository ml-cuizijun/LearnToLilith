...
- [ ] CI、Delivery、Deployment 差在哪？游戏生产为什么默认不停在人闸上？
- [ ] 为什么 staging 测过必须同一 digest 上 prod？怎么证明？
- [ ] 哪几道闸门硬阻断？扫描和金丝雀怎样被人情拆掉？
- [ ] Jenkins 四块红线？队列 Pending 先看什么？
- [ ] 回滚前问哪三件事？expand/contract 是什么？GitOps 怎么回？
- [ ] 服务端镜像、客户端整包、数值热更、改超时，各走哪条 CI？
