...
**本章不讲：** 阶段设计、金丝雀 SLI、digest 晋升、DORA → [02](../02-CI-CD/)；Harbor、扫描、禁 latest → [03](../03-制品与镜像/)；Git 分支保护、revert → [01](../01-Git工作流/)；GitOps sync → [03-22](../../03-Kubernetes/22-GitOps-ArgoCD与Tekton/)；Jenkins Master 队列、K8s 弹性 Agent 细节 → [02](../02-CI-CD/)；开服冻结流程、升级路径 → [06](../06-运维平台与Oncall/)。
