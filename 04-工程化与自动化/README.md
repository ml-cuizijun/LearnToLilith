...
> Shell/Python/Go 在 [05-开发能力](../05-开发能力/)；GitOps（ArgoCD/Helm）在 [03-22](../03-Kubernetes/22-GitOps-ArgoCD与Tekton/)。
...
密钥不单开 Vault：K8s Secret 见 [03-12](../03-Kubernetes/12-配置与密钥/)；云上 RAM/IAM 见 [06-07](../06-云平台/07-IAM与多账号/)；镜像扫描见 03。
