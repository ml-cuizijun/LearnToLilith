...
- [ ] 一次构建、digest 贯通怎么画？`docker tag` 和 `docker build` 谁叫复制？
- [ ] 生产为什么禁 latest？immutable 了还要不要 digest？
- [ ] 多阶段后还胖查哪？策划表为什么不能打进业务镜像？
- [ ] Harbor 比私有 Hub 多哪几项？开服清单写哪句？
- [ ] 拉失败上节点怎么分流？GC 前对什么？
- [ ] Critical / 密钥进层 / Chart 三件怎么处理？热更和镜像怎么拆？
