...
- [ ] Trunk-based 和 GitFlow 差在哪天爆？服务端和客户端怎么拆？
- [ ] rebase / merge / squash 各何时用？已推送公共分支能不能 rebase？
- [ ] 坏 commit 已在 main，revert 还是 reset？GitOps 只 undo 行不行？
- [ ] hotfix 从哪拉？cherry-pick 对准哪颗 SHA？
- [ ] bisect 怎么跑？观测滞后会怎样？reflog 新 clone 有没有？
- [ ] 游戏热更、客户端整包、改 nginx 超时，各走 Git/CI、release 线还是 Ansible/CDN？
