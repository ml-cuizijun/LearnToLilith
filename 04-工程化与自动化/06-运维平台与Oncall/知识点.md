...
**本章不讲：** 流水线门禁、digest 晋升 → [02](../02-CI-CD/)；GitOps 发布 → [03-22](../../03-Kubernetes/22-GitOps-ArgoCD与Tekton/)；开合服步骤、回档 → [07-02](../../07-游戏运维专题/02-开服合服/) / [07-07](../../07-游戏运维专题/07-玩家数据备份与回档/)；SLO / 监控指标怎么设 → [03-18](../../03-Kubernetes/18-监控与可观测性/) / [01-22](../../01-基础底座/22-监控与告警/)；IAM、账号 → [06-07](../../06-云平台/07-IAM与多账号/)。Toil / ICS / 无责复盘方法论不单开模块，结合 oncall 与游戏稳定性章口述。
