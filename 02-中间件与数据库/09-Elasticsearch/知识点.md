...
**本章不讲：** 采集、EFK vs Loki 架构 → [03-19 日志](../../03-Kubernetes/19-日志管理/)；消息管道、积压 → [05 Kafka](../05-Kafka/)；文档库、TTL 邮件 → [06 MongoDB](../06-MongoDB/)；列存 SQL 细节不单开，选型见 3.6。
...
| `_cat/allocation` | 磁盘 | <80% | ≥85% flood stage |
