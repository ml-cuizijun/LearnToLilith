...
**本章不讲：** etcd Raft、quorum、备份、磁盘 → [03-02 etcd](../../03-Kubernetes/02-etcd/)；ConfigMap / Secret 注入 → [03-12](../../03-Kubernetes/12-配置与密钥/)；优雅退出、摘流顺序细节 → [03-04 Pod](../../03-Kubernetes/04-Pod生命周期/)；网关动态路由、APISIX+etcd → [04 接入网关](../04-接入网关/)；Kafka 老集群的 ZK 运维 → [05 Kafka](../05-Kafka/)。
