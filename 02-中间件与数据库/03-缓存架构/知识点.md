...
**本章不讲：** fork、大 key、Cluster slot、ZSet 排行实现 → [02 Redis](../02-Redis/)；钱包权威、主从延迟读旧 → [01 MySQL](../01-MySQL/)；网关超时、499/504、限流桶 → [04 接入网关](../04-接入网关/)；活动压测、开服容量 → [07-05](../../07-游戏运维专题/05-活动高峰与压测/)；回档多存储对齐 → [07-07](../../07-游戏运维专题/07-玩家数据备份与回档/)。
