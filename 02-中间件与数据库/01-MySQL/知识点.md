...
**本章不讲：** 水平拆分、分片键、ShardingSphere / Vitess / TiDB → [07 分库分表](../07-分库分表与中间件/)；合服步骤、回档审批、多存储对齐 → [07-02 开服合服](../../07-游戏运维专题/02-开服合服/)、[07-07 回档](../../07-游戏运维专题/07-玩家数据备份与回档/)；Redis 不当账本、缓存怎么写 → [02 Redis](../02-Redis/)、[03 缓存架构](../03-缓存架构/)。
