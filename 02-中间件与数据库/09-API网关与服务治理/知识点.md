...
- [ ] 超时链从外到内怎么排？SDK 比网关短会看到什么码？
- [ ] 502 / 504 / 499 / 503 各看 error.log 哪类关键字？不要做什么？
- [ ] 鉴权、限流、熔断、灰度分别挂哪一层？限流按 IP 的坑？
- [ ] 对上游 keepalive 为什么要开？被动探活过严会怎样？
- [ ] 战斗长连接为什么不能挂默认七层？reload 和 USR2 差在哪？
- [ ] APISIX etcd 挂了该不该重启数据面？证书链丢了为什么不像满屏 5xx？
