...
先别画满整板。这一章后半全是你会取舍的：**每个框解决什么、引入什么故障域、什么时候不该上。** 前面的管线和角色，是为了让你画的时候不把组件名堆成一张图。
...
- [6. 常用命令](#6-常用命令)
- [7. 常用操作](#7-常用操作)
  - [7.1 万级监控](#71-万级-pod-监控怎么拆)
  - [7.2 网格分批](#72-网格分批先无状态)
  - [7.3 多集群](#73-多集群先独立再统一)
  - [7.4 游戏控制器](#74-游戏控制器怎么选)
  - [7.5 GPU 隔离](#75-gpu-池怎么隔离)
- [8. 生产排障](#8-生产排障)
- [9. 必会 · 常考](#9-必会--常考)
- [合上书](#合上书问自己)
