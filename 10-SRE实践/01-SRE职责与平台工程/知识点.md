...
先别动手。这一章后半全是你会动手的：**平台怎么分阶段建、契约挂哪、值班怎么验收、Toil 怎么砍、Operator 什么时候不写。** 前面的角色和原理，是为了让你动手时不选错路。
...
- [6. 常用命令](#6-常用命令)
- [7. 常用操作](#7-常用操作)
  - [7.1 砍 Toil](#71-砍-toil-立项)
  - [7.2 Operator 边界](#72-写-operator-还是-job)
  - [7.3 派驻嵌入](#73-派驻还是收回平台)
  - [7.4 多语言接入](#74-多语言流水线接入)
  - [7.5 值班负荷](#75-值班负荷与-oncall-边界)
  - [7.6 自助回滚](#76-自助开环境看日志回滚)
  - [7.7 门禁挂钩](#77-slo-门禁挂发布入口)
- [8. 生产排障](#8-生产排障)
- [9. 必会 · 常考](#9-必会--常考)
- [合上书](#合上书问自己)
